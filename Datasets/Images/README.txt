How to configure the datasets:
    PTL-Crosswalk Dataset:
        Download the PTL-Crosswalk-Base subset from < https://drive.google.com/file/d/1xi4LJnp7pTeP0lonrSqkhCbCS_IbytQe/view?usp=sharing >. Extract the files. Put the < PTL-Crosswalk-Base > folder inside < /Datasets/Images/PTL-Crosswalk Dataset/ >.
