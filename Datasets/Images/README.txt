How to configure the datasets:
    PTL-Crosswalk Dataset:
        Download the PTL-Crosswalk-Base subset from < https://drive.google.com/file/d/1u3UNxh2f6E0EYr12xcHF0shezWXrExIr/view?usp=sharing >. Extract the files. Put the < PTL-Crosswalk-Base > folder inside < /Datasets/Images/PTL-Crosswalk Dataset/ >.
