...
model_state_dict_path = home_dir + 'Path to: /Codes/CNNs/EfficientNet-M/B2/state_dict.pth'
train_history_save_path = home_dir + 'Path to: /Codes/CNNs/EfficientNet-M/B2/history.json'
...
if __name__ == '__main__':
    ...
    # Model
    model = EfficientNet_M.MakeModel(net_type=net_type,pretrained=pretrained)
    if load_state_dict:
