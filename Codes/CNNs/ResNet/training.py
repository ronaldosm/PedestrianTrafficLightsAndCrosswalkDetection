...
model_state_dict_path = home_dir + 'Path to: /Codes/CNNs/ResNet/my_model.pth'
train_history_save_path = home_dir + 'Path to: /Codes/CNNs/ResNet/my_history.json'
...
if __name__ == '__main__':
    ...
    # Model
    model = ResNet50.MakeModel(pretrained=pretrained)
    if load_state_dict:
