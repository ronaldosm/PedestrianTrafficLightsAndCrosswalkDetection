...
model_state_dict_path = home_dir + 'Path to: /Codes/CNNs/LytNetV2-M/state_dict.pth'
train_history_save_path = home_dir + 'Path to: /Codes/CNNs/LytNetV2-M/history.json'
...
if __name__ == '__main__':
    ...
    # Model
    model = LytnetV2_M.MakeModel(pretrained=pretrained,freeze=freeze)
    if load_state_dict:
