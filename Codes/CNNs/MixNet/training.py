...
model_state_dict_path = home_dir + 'Path to: /Codes/CNNs/MixNet/my_model.pth'
train_history_save_path = home_dir + 'Path to: /Codes/CNNs/MixNet/my_history.json'
