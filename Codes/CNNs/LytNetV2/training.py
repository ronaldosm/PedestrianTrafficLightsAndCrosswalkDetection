...
pretrained = True              # If true, loads LytNetV2 original state-dict (found at https://github.com/samuelyu2002/ImVisible)
freeze = False                 # If true, freezes all layers except the last one
loss_functions = ['MSE','BCE','MSE']
...
model_state_dict_path = home_dir + 'Path to: /Codes/CNNs/LytNetV2/my_model.pth'
train_history_save_path = home_dir + 'Path to: /Codes/CNNs/LytNetV2/my_history.json'
...
if __name__ == '__main__':
    ...
    # Model
    model = my_lytnetV2.MakeModel(pretrained=pretrained,freeze=freeze)
    if load_state_dict:
