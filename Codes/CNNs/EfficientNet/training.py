...
model_state_dict_path = home_dir + 'Path to: /Codes/CNNs/EfficientNet/B2/my_model.pth'
train_history_save_path = home_dir + 'Path to: /Codes/CNNs/EfficientNet/B2/my_history.json'
...
if __name__ == '__main__':
    ...
    # Model
    model = EfficientNet.MakeModel(net_type=net_type,pretrained=pretrained)
    if load_state_dict:
